...
CREATE TABLE `t400docente` (
	...
	`supervisao_ass_medica` TINYINT(1) NULL DEFAULT '0',
	`servico_clinico` TINYINT(1) NULL DEFAULT '0',
...
CREATE TABLE `t700avaliacao` (
	...
	`t905_modalidade_id` INT(11) NULL DEFAULT NULL,
	`t906_tipo_ato_id` INT(11) NULL DEFAULT NULL,
	`conceito_ind_2_2` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_3` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_4` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_5` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_6` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_7` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_8` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_9` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_10` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_11` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_12` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_13` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_15` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_17` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_18` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_19` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_2_20` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_3_6` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_3_7` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`conceito_ind_3_8` ENUM('NSA','1','2','3','4','5') NULL DEFAULT 'NSA',
	`t900_usuario_id` BIGINT(20) NULL DEFAULT NULL,
	`dt_avaliacao` DATETIME NULL DEFAULT NULL,
	`nota_ind1` DOUBLE(12,2) NULL DEFAULT NULL,
	`nota_ind2` DOUBLE(12,2) NULL DEFAULT NULL,
	`nota_ind3` DOUBLE(12,2) NULL DEFAULT NULL,
