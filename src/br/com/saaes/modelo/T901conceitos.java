...
public class T901conceitos implements Serializable {
    ...
    public T901conceitos() {
    }

    public T901conceitos(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof T901conceitos)) {
            return false;
        }
        T901conceitos other = (T901conceitos) object;
    ...
    public String toString() {
        return "br.com.saaes.modelo.T901conceitos[ id=" + id + " ]";
    }
