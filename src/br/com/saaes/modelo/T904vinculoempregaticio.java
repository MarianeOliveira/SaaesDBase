...
public class T904vinculoempregaticio implements Serializable {
    ...
    public T904vinculoempregaticio() {
    }

    public T904vinculoempregaticio(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof T904vinculoempregaticio)) {
            return false;
        }
        T904vinculoempregaticio other = (T904vinculoempregaticio) object;
    ...
    public String toString() {
        return "br.com.saaes.modelo.T904vinculoempregaticio[ id=" + id + " ]";
    }
